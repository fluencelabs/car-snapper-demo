...
# copy something to /tmp dir of the sealingService
cp -r .fluence .fluence/tmp/volumes/services/sealingService/service/tmp/

# run sealingService in MREPL
fluence service repl sealingService

# inside MREPL, call pack
1> call sealingService pack ["/tmp/.fluence", "/tmp/", "dot_fluence.car"]
