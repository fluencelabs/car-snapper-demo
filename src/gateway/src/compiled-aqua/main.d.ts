...
export type ComputeSizePersistResult = Promise<{ errors: string[]; cid: string | null; worker: { host_id: string; pat_id: string; worker_id: string | null; }; ls: string[]; vault_put: string; }[]>;
